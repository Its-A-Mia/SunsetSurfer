      ...
      <div className="footerContainer">
        ...
        <div className="text-bg">
          <a
            ...
            rel="noreferrer"
          >
            <svg className="github-icon" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24">
              <path
                className="github-icon-path"
                fill="white"
          ...
          <span className="text-bg-right-perspective"></span>
        </div>
      </div>
    </footer>
  );
